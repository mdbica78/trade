...
2. Read [`status.md`](./status.md) — what's currently in progress, what's next, and any decision still waiting on the user's validation.
...
├── roles/
│   ├── coordinator.md       — the main chat: picks work, dispatches checks, escalates
│   ├── code-reviewer.md     — independent review against acceptance criteria
│   └── test-runner.md       — independent test execution
├── architecture/
